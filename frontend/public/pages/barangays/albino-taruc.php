...
// Create page builder with correct include path for barangays/
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                <li class="mb-3"><a href="../../public/tourist-spots.php">Tourist Spots</a></li>
                                <li class="mb-3"><a href="../../public/delicacies.php">Local Delicacies</a></li>
                                <li class="mb-3"><a href="../../public/about.php">About Socorro</a></li>
                                <li class="mb-3"><a href="../../public/contact-us.php">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
$options = [
    'includes' => [
        ['file' => 'includes/header-section.php', 'data' => [
            ...
            'breadcrumbItems' => [
                ["text" => "Home", "url" => "/barangays.php"],
                ["text" => "Barangay Details", "url" => null]
            ]
        ]],
        ['content' => $content],

                    ...
                    <div class="pb-3">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <ul class="simList2col" id="adjacent-bgy-list">
                                <li><a href="/barangays/navarro">Navarro (Poblacion), Socorro, Surigao del Norte</a></li>
...
// Build the page
$pageBuilder->buildCustomPage($content, 'Del Pilar', 'Del Pilar - Barangay Details', $options);
?>